...
New project:
```bash
curl -o CLAUDE.md https://raw.githubusercontent.com/mhenke/john-ousterhout-skills/v0.2.2/CLAUDE.md
```

Existing project (append):
```bash
echo "" >> CLAUDE.md
curl https://raw.githubusercontent.com/mhenke/john-ousterhout-skills/v0.2.2/CLAUDE.md >> CLAUDE.md
```
