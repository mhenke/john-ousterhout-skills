...
Agent definition for coding agents that should write APOSD-compliant code. This agent follows the 15 behavioral rules from `skills/aposd/SKILL.md` and can invoke the command skills on demand.
